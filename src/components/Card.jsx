    ...
    <div className="mt-5">
      {showData === true ? (
        <div className="container">
          <div className="card mb-3 mx-auto bg-info text-light">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  src="https://images.pexels.com/photos/15481505/pexels-photo-15481505.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
